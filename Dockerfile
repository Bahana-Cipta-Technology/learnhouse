...
ENV NEXT_PUBLIC_LEARNHOUSE_API_URL=https://lms.bct.co.id/api/v1/
ENV NEXT_PUBLIC_LEARNHOUSE_BACKEND_URL=https://lms.bct.co.id/
ENV NEXT_PUBLIC_LEARNHOUSE_DOMAIN=lms.bct.co.id
